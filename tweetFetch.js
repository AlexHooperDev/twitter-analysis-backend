...
const fetchTweets = async () => {
  const apiCall = fetch('https://api.twitter.com/1.1/statuses/user_timeline.json?screen_name=alexghooper09&include_rts=false&excludereplies=true&count=200&tweet_mode=extended', {
    headers: {
